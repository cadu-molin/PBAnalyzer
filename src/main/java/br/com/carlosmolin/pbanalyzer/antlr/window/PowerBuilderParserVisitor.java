...
public interface PowerBuilderParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PowerBuilderParser#sql_statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSql_statement(PowerBuilderParser.Sql_statementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PowerBuilderParser#bind_param}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBind_param(PowerBuilderParser.Bind_paramContext ctx);
	/**
