// Generated from PowerBuilderParser.g4 by ANTLR 4.13.2
...
public class PowerBuilderParser extends Parser {
	...
	public static final int
		...
		ULONG=22, WINDOW=23, OLEOBJECT=24, TRUE=25, FALSE=26, GLOBAL=27, SHARED=28, 
		END=29, INDIRECT=30, VARIABLES=31, FORWARD=32, PUBLIC=33, PRIVATE=34, 
		FUNCTION=35, SUBROUTINE=36, READONLY=37, PROTOTYPES=38, TYPE=39, ON=40, 
		TO=41, FROM=42, REF=43, NULL_=44, UPDATE=45, CASE=46, DYNAMIC=47, WITHIN=48, 
		PRIVATEWRITE=49, PROTECTED=50, PRIVATEREAD=51, PROTECTEDREAD=52, PROTECTEDWRITE=53, 
		LOCAL=54, EVENT=55, OPEN=56, GOTO=57, ELSE=58, IF=59, THEN=60, ELSEIF=61, 
		TRY=62, EXIT=63, CHOOSE=64, IS=65, CONTINUE=66, DO=67, WHILE=68, FOR=69, 
		CLOSE=70, NEXT=71, LOOP=72, UNTIL=73, STEP=74, CATCH=75, FINALLY=76, THROW=77, 
		RELEASE=78, CREATE=79, DESTROY=80, USING=81, POST=82, TRIGGER=83, SELECT=84, 
		DELETE=85, INSERT=86, DESCRIBE=87, RETURN=88, OR=89, AND=90, NOT=91, CALL=92, 
		HALT=93, SUPER=94, LIBRARY=95, SYSTEM=96, RPCFUNC=97, ALIAS=98, THROWS=99, 
		AUTOINSTANTIATE=100, DESCRIPTOR=101, SQLCA=102, IMMEDIATE=103, EXECUTE=104, 
		DECLARE=105, PROCEDURE=106, INTO=107, VALUES=108, WHERE=109, COMMIT=110, 
		CURSOR=111, PREPARE=112, FETCH=113, SET=114, CONNECT=115, DISCONNECT=116, 
		CONSTANT=117, SELECTBLOB=118, UPDATEBLOB=119, ROLLBACK=120, EQ=121, GT=122, 
		GTE=123, LT=124, LTE=125, GTLT=126, PLUS=127, MINUS=128, PLUSEQ=129, MINUSEQ=130, 
		COLONCOLON=131, MULT=132, DIV=133, MULTEQ=134, DIVEQ=135, CARAT=136, LCURLY=137, 
		RCURLY=138, LBRACE=139, RBRACE=140, TICK=141, DQUOTED_STRING=142, QUOTED_STRING=143, 
		COMMA=144, SEMI=145, LPAREN=146, RPAREN=147, COLON=148, DQUOTE=149, TQ=150, 
		DOUBLE_PIPE=151, DOTDOTDOT=152, AT=153, UNDERSCORE=154, NUMBER=155, DOT=156, 
		DATE=157, TIME=158, ENUM=159, ID=160, EXPORT_HEADER=161, LINE_CONTINUATION=162, 
		SL_COMMENT=163, ML_COMMENT=164, WS=165;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'UINT'", "'UNSIGNEDLONG'", "'ULONG'", "'WINDOW'", "'OLEOBJECT'", "'TRUE'", 
			"'FALSE'", "'GLOBAL'", "'SHARED'", "'END'", "'INDIRECT'", "'VARIABLES'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ULONG", "WINDOW", "OLEOBJECT", "TRUE", "FALSE", "GLOBAL", "SHARED", 
			"END", "INDIRECT", "VARIABLES", "FORWARD", "PUBLIC", "PRIVATE", "FUNCTION", 
			"SUBROUTINE", "READONLY", "PROTOTYPES", "TYPE", "ON", "TO", "FROM", "REF", 
			"NULL_", "UPDATE", "CASE", "DYNAMIC", "WITHIN", "PRIVATEWRITE", "PROTECTED", 
			"PRIVATEREAD", "PROTECTEDREAD", "PROTECTEDWRITE", "LOCAL", "EVENT", "OPEN", 
			"GOTO", "ELSE", "IF", "THEN", "ELSEIF", "TRY", "EXIT", "CHOOSE", "IS", 
			"CONTINUE", "DO", "WHILE", "FOR", "CLOSE", "NEXT", "LOOP", "UNTIL", "STEP", 
			"CATCH", "FINALLY", "THROW", "RELEASE", "CREATE", "DESTROY", "USING", 
			"POST", "TRIGGER", "SELECT", "DELETE", "INSERT", "DESCRIBE", "RETURN", 
			"OR", "AND", "NOT", "CALL", "HALT", "SUPER", "LIBRARY", "SYSTEM", "RPCFUNC", 
	...
	public final Start_ruleContext start_rule() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 71496428005883902L) != 0) || ((((_la - 117)) & ~0x3f) == 0 && ((1L << (_la - 117)) & 8933531975681L) != 0) );
			setState(244);
			match(EOF);
			}
		}
	...
	public final Forward_declContext forward_decl() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 71495221120073726L) != 0) || _la==UNDERSCORE || _la==ID );
			setState(268);
			match(END);
			setState(269);
			match(FORWARD);
	...
	public final Datatype_declContext datatype_decl() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 71494671095824382L) != 0) || _la==UNDERSCORE || _la==ID) {
				{
				setState(298);
				_errHandler.sync(this);
	...
	public final Type_variables_declContext type_variables_decl() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 71494671095824382L) != 0) || ((((_la - 117)) & ~0x3f) == 0 && ((1L << (_la - 117)) & 8933531975681L) != 0)) {
				{
				setState(311);
				_errHandler.sync(this);
	...
	public final Variable_decl_subContext variable_decl_sub() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17451474325864448L) != 0)) {
				{
				setState(343);
				access_modif_part();
				}
	...
	public final Array_decl_subContext array_decl_sub() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 127)) & ~0x3f) == 0 && ((1L << (_la - 127)) & 268435459L) != 0)) {
				{
				setState(414);
				_errHandler.sync(this);
				_la = _input.LA(1);
	...
	public final Constant_decl_subContext constant_decl_sub() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1125925676646400L) != 0)) {
				{
				setState(445);
				access_type();
				}
	...
	public final Function_forward_declContext function_forward_decl() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8933565530110L) != 0) || _la==UNDERSCORE || _la==ID) {
				{
				setState(468);
				parameters_list_sub();
				}
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 95)) & ~0x3f) == 0 && ((1L << (_la - 95)) & 29L) != 0)) {
				{
				setState(472);
	...
	public final Functions_forward_declContext functions_forward_decl() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 35465976048779264L) != 0)) {
				{
				{
				setState(530);
				function_forward_decl();
	...
	public final Function_bodyContext function_body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -3747381169499406338L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 142799353742729325L) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & 549453825L) != 0)) {
				{
				{
				setState(563);
				statement();
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(694);
					_la = _input.LA(1);
					if ( !(((((_la - 127)) & ~0x3f) == 0 && ((1L << (_la - 127)) & 611L) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Sql_connect_statementContext sql_connect_statement() throws RecognitionException {
		...
		try {
			...
			setState(1054);
			_la = _input.LA(1);
			if ( !(((((_la - 115)) & ~0x3f) == 0 && ((1L << (_la - 115)) & 35L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Describe_function_callContext describe_function_call() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 216208653689290880L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 279240098305L) != 0) || _la==UNDERSCORE || _la==ID) {
					{
					setState(1247);
					identifier();
					setState(1248);
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 252387018774937598L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 2738188852691980801L) != 0) || ((((_la - 137)) & ~0x3f) == 0 && ((1L << (_la - 137)) & 16124513L) != 0)) {
					{
					setState(1254);
					expression_list();
					}
	...
	public final Assignment_statementContext assignment_statement() throws RecognitionException {
		...
		try {
			...
			case ID:
				...
				setState(1277);
				_la = _input.LA(1);
				if ( !(((((_la - 121)) & ~0x3f) == 0 && ((1L << (_la - 121)) & 25345L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Identifier_arrayContext identifier_array() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((((_la - 127)) & ~0x3f) == 0 && ((1L << (_la - 127)) & 268435555L) != 0)) {
					{
					setState(1740);
					_errHandler.sync(this);
					_la = _input.LA(1);
					if (((((_la - 127)) & ~0x3f) == 0 && ((1L << (_la - 127)) & 99L) != 0)) {
						{
						setState(1739);
						operator();
						}
	...
	public static class DataTypeSubContext extends ParserRuleContext {
		...
		public TerminalNode WINDOW() { return getToken(PowerBuilderParser.WINDOW, 0); }
		public TerminalNode OLEOBJECT() { return getToken(PowerBuilderParser.OLEOBJECT, 0); }
	...
	public final DataTypeSubContext dataTypeSub() throws RecognitionException {
		...
		try {
			...
			setState(1814);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 33554430L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
